...
class TranslationService:
    ...
    VIETNAMESE = {
        ...
        "msg.folder_exists": "Tên thư mục đã tồn tại.",
        "msg.folder_create_error": "Không thể tạo thư mục: {0}",
        ...
        "msg.move_folder_save_first": "Hãy lưu ghi chú trước khi di chuyển.",
        "msg.no_folder": "Chưa có thư mục nào. Hãy tạo thư mục trước.",
        "msg.choose_folder": "Chọn thư mục đích:",
        "msg.confirm_move": "Xác nhận di chuyển",
        "msg.delete_folder_confirm": "Xóa thư mục '{0}'? Các ghi chú bên trong sẽ được đưa về thư mục gốc.",
        "msg.import_error": "Không thể đọc file: {0}",
        "msg.move_folder_error": "Không thể di chuyển ghi chú: {0}",
        "msg.save_failed": "Không thể lưu ghi chú: {0}",
        "msg.delete_error": "Không thể xóa ghi chú: {0}",
        "msg.delete_folder_error": "Không thể xóa thư mục: {0}",
        ...
        "msg.export_md_error": "Lỗi Markdown",
        "msg.export_md_error_text": "Không xuất được Markdown: {error}",
    ...
    ENGLISH = {
        ...
        "msg.folder_exists": "A folder with this name already exists.",
        "msg.folder_create_error": "Could not create folder: {0}",
        ...
        "msg.move_folder_save_first": "Save the note before moving it.",
        "msg.no_folder": "There are no folders yet. Create one first.",
        "msg.choose_folder": "Choose a destination folder:",
        "msg.confirm_move": "Confirm move",
        "msg.delete_folder_confirm": "Delete folder '{0}'? Its notes will be moved to the root folder.",
        "msg.import_error": "Could not read file: {0}",
        "msg.move_folder_error": "Could not move the note: {0}",
        "msg.save_failed": "Could not save the note: {0}",
        "msg.delete_error": "Could not delete the note: {0}",
        "msg.delete_folder_error": "Could not delete the folder: {0}",
        ...
        "msg.export_md_error": "Markdown Error",
        "msg.export_md_error_text": "Could not export Markdown: {error}",
